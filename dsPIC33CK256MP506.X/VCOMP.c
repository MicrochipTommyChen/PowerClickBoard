...
{
    0x58BFFFFF, // Coefficient B0 will be multiplied with error input e(n-0)
    0xAF66FFFF, // Coefficient B1 will be multiplied with error input e(n-1)
    0xA772FFFF, // Coefficient B2 will be multiplied with error input e(n-2)
    0x50CBFFFF  // Coefficient B3 will be multiplied with error input e(n-3)
};
