...
; Save working registers
    ...
    push w8
    push w10
    push ACCAL                              ; save accumulator A register (LOW WORD:   bit <15?>)
    push ACCAH                              ; save accumulator A register (HIGH WORD:  bit <31?6>)
    push ACCAU                              ; save accumulator A register (UPPER BYTE: bit <39?2>)
    push ACCBL                              ; save accumulator B register (LOW WORD:   bit <15?>)
    push ACCBH                              ; save accumulator B register (HIGH WORD:  bit <31?6>)
    push ACCBU                              ; save accumulator B register (UPPER BYTE: bit <39?2>)
...
; Restore working registers in reverse order
    ...
    pop ACCBU                               ; restore accumulator B register (UPPER BYTE: bit <39?2>)
    pop ACCBH                               ; restore accumulator B register (HIGH WORD:  bit <31?6>)
    pop ACCBL                               ; restore accumulator B register (LOW WORD:   bit <15?>)
    pop ACCAU                               ; restore accumulator A register (UPPER BYTE: bit <39?2>)
    pop ACCAH                               ; restore accumulator A register (HIGH WORD:  bit <31?6>)
    pop ACCAL                               ; restore accumulator A register (LOW WORD:   bit <15?>)
