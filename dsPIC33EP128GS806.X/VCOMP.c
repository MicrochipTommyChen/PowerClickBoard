...
{
    0x68C7FFFF, // Coefficient A1 will be multiplied with controller output u(n-1)
    0x8DBC0001, // Coefficient A2 will be multiplied with controller output u(n-2)
    0x9E560002  // Coefficient A3 will be multiplied with controller output u(n-3)
};

volatile int32_t VCOMP_BCoefficients [4] =
{
    0x53B00001, // Coefficient B0 will be multiplied with error input e(n-0)
    0xB3FE0001, // Coefficient B1 will be multiplied with error input e(n-1)
    0xAC7E0001, // Coefficient B2 will be multiplied with error input e(n-2)
    0x4C300001  // Coefficient B3 will be multiplied with error input e(n-3)
};
...
volatile int16_t VCOMP_pterm_factor = 0x68F6;     // Q15 fractional of the P-Term factor
volatile int16_t VCOMP_pterm_scaler = 0x0001;     // Bit-shift scaler of the P-Term factor
